(module
    ...
    ;; Following two functions convert r^2 cartesian space to linear space
    ...
    ;; Gets a piece form the board. Out of range causes a trap
    ...
    ;; Detect if values are within range (inclusively)
